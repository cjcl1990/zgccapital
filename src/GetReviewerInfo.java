...
public class GetReviewerInfo
{
    ...
    public ArrayList<String> reviewer_info(String reviewerID) {
        ...
        String Location = "";
        List Recent_rating = new ArrayList();
        try {
        ...
        String Recent_rating_joined = StringUtils.join(
                Recent_rating, " ");
        attributes.addAll(Arrays.asList(new String[] { reviewerID, Total_reviews,
...
//            if (i > -1) {
//                ArrayList info = reviewer_info(reviewer);
//                String insert_q;
//                if (info != null) {
//                    String insert_q = "replace into attr values (";
//                    for (String value : info) {
//                        insert_q = insert_q + "'" + value + "',";
//                    }
...
//                    c =
//                            DriverManager.getConnection("jdbc:sqlite:" + this.outputDB);
...
//    }
    ...
    public HashSet<String> read_id() throws FileNotFoundException {
        HashSet reviewerIDs = new HashSet();
        Scanner s = new Scanner(new File(this.ReviewIDFile));
        while (s.hasNext()) {
